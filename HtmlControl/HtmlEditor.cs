...
namespace HtmlControl
{
    ...
    public partial class Editor : UserControl, SearchableBrowser
    {
       ...
       // public event TickDelegate Tick;
        ...
        public void SetupFont(Font font, Color color, int size)
        {
            fontComboBox.SelectedIndex = fontComboBox.FindString(font.FontFamily.Name);
            fontSizeComboBox.SelectedIndex = fontSizeComboBox.FindString(size.ToString());
            this.FontSize = FontSize.Five;
            this.FontName = font.FontFamily;
            this.EditorForeColor = color;
        ...
        {
            string SetupHtml = "<html><head></head><body></body></html>";
            webBrowser1.DocumentText = SetupHtml;
            doc =
        ...
        public override Color BackColor
        {
            ...
            set
            {
                ...
                if (ReadyState == ReadyState.Completed)
                {
...
//        }
        ...
        //    // 
        //    this.Name = "Editor";
        //    this.Load += new System.EventHandler(this.Editor_Load_1);
